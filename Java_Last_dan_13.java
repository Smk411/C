...
class Calc{
	...
	public static void input_score(int num[],int kor[],int eng[],int math[],String name[]){
...
public static void main(String[] args) {
		...
		while(true){
			...
			switch (calc1.menu_num){
				case 1:
					calc1.lineprint(34);
					calc1.input_score(calc1.num,calc1.kor,calc1.eng,calc1.math,calc1.name);
					calc1.lineprint(34);
					break;
				case 2:
