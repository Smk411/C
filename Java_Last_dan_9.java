...
public static void main(String[] args) {
		...
		calc1.lineprint(34);
		System.out.println("번호  국어  영어  수학  총점  평균 	등수");
		calc1.lineprint(34);
		for(i=0;i<3;i++){
		System.out.printf("%2d%4d%3d%3d%4d%6.2f%4d\n",calc1.num[i],calc1.kor[i],calc1.eng[i],calc1.math[i],
...
//오버로딩을 사용하는 이유: 다른사람이 작업한 메소드를 넘겨 받았을때 같은 이름의 메소드를 기능만 다르게하여 검색이 용이하게 하기 위함