...
class Search{
	...
	public Search(){
		default_name = "홍길남";
		default_value=100;
		for(int i=0;i<Search.getMember();i++){
			this.kor[i]=default_value;
			this.eng[i]=default_value;
			this.math[i]=default_value;
			this.name[i]=default_name;
			
		}
	}
	public Search(String n,int a, int b, int c){
...
public class Java_Last_dan_21{

public static void main(String[] args) {
		Scanner s = new Scanner(System.in);
		Calc calc1=new Calc();
		Calc calc2=new Calc("슈퍼맨",20,20,20);
